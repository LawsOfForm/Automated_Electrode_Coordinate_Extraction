...
def create_dataset(subset: str, validation_cases: int, test_cases: int, seed: int = 42):
    volume_suffix: str = "petra_cut_pads.nii.gz"
    mask_suffix: str = "cylinder_plus_plug_ROI.nii.gz"
    root_dir = "/media/MeMoSLAP_Subjects/derivatives/automated_electrode_extraction"
...
def main():
    ...
    val_dataset = create_dataset(
        subset="validation", validation_cases=vc, test_cases=tc
    )
