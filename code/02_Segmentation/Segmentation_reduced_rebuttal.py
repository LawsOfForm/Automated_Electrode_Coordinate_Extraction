...
DEFAULT_MODEL_NAME  = 'c_attention_reduced_channels_best_metric_model.pth'
...
def main(args):
    ...
    for subject_dir in subject_dirs:
        ...
        for nifti_file in nifti_files:
            output_segmentation_path = nifti_file.replace('_PDw.nii', '_PDw_inference_reduced_network.nii.gz')
