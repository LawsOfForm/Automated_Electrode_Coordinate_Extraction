...
DEFAULT_MODEL_NAME  = 'best_metric_model_rebuttal_063_18062026_5level_incereased_Adamax.pth'
...
def main(args):
    ...
    for subject_dir in subject_dirs:
        ...
        for nifti_file in nifti_files:
            output_segmentation_path = nifti_file.replace('_PDw.nii', '_PDw_inference_increased_network.nii.gz')
